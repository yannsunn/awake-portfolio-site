...
export const WORKS = [
  {
    ...
    title: "コーポレートサイト",
    category: "ホームページ制作",
    description: "多機能コーポレートサイト。会社概要・サービス詳細・FAQ・お問い合わせを統合。",
    ...
    imageUrl: "/images/screenshots/awake-corp-hero.jpg",
  ...
  },
  {
    ...
    title: "アパレルECサイト",
    category: "ホームページ制作",
    description: "OEM・ODM対応アパレルEC。商品管理・決済・在庫管理を統合したフルスペックサイト。",
    ...
    imageUrl: "/images/screenshots/apparel-ec-hero.jpg",
  ...
  },
  {
    ...
    title: "製造業LP",
    category: "ホームページ制作",
    description: "金属加工業向けLP型サイト。製品ギャラリー・実績訴求に特化したデザイン。",
    ...
    imageUrl: "/images/screenshots/manufacturing-hero.jpg",
  ...
  },
  {
    ...
    title: "FP個人サイト",
    category: "ホームページ制作",
    description: "ファイナンシャルプランナー個人サイト。LINE相談への導線に特化。",
    ...
    imageUrl: "/images/screenshots/financial-hero.jpg",
  ...
  },
  {
    ...
    title: "プロフィールサイト",
    category: "ホームページ制作",
    description: "1ページ完結型プロフィールサイト。Instagram・Google Map埋め込み対応。",
    ...
    imageUrl: "/images/screenshots/profile-hero.jpg",
